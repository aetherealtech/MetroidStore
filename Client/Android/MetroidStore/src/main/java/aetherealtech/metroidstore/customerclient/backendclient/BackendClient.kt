...
class BackendClient(
    ...
    suspend fun getProducts(): ImmutableList<ProductSummary> {
        ...
        val backendProducts = Json.decodeFromString<List<aetherealtech.metroidstore.customerclient.backendmodel.ProductSummary>>(
            body.string()
        )
    ...
    suspend fun getProductDetails(id: ProductID): ProductDetails {
        ...
        val backendProduct = Json.decodeFromString<aetherealtech.metroidstore.customerclient.backendmodel.ProductDetails>(
            body.string()
        )
    ...
    private fun handleCartResponse(response: Response): ImmutableList<CartItem> {
        ...
        val backendCartItems = Json.decodeFromString<List<aetherealtech.metroidstore.customerclient.backendmodel.CartItem>>(
            body.string()
        )
    ...
    suspend fun getAddresses(): ImmutableList<UserAddressSummary> {
        ...
        val backendAddresses = Json.decodeFromString<List<aetherealtech.metroidstore.customerclient.backendmodel.UserAddressSummary>>(
            body.string()
        )
    ...
    suspend fun getShippingMethods(): ImmutableList<ShippingMethod> {
        ...
        val backendMethods = Json.decodeFromString<List<aetherealtech.metroidstore.customerclient.backendmodel.ShippingMethod>>(
            body.string()
        )
    ...
    suspend fun getPaymentMethods(): ImmutableList<PaymentMethodSummary> {
        ...
        val backendMethods = Json.decodeFromString<List<aetherealtech.metroidstore.customerclient.backendmodel.PaymentMethodSummary>>(
            body.string()
        )
    ...
    suspend fun getOrders(): ImmutableList<OrderSummary> {
        ...
        val backendOrders = Json.decodeFromString<List<aetherealtech.metroidstore.customerclient.backendmodel.OrderSummary>>(
            body.string()
        )
    ...
    suspend fun placeOrder(order: NewOrder): OrderID {
        val backendOrder = aetherealtech.metroidstore.customerclient.backendmodel.NewOrder(
